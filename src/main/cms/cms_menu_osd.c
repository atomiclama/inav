...
static const OSD_Entry menuOsdElemsEntries[] =
{
    ...
    OSD_ELEMENT_ENTRY("RX UP RSSI DBM", OSD_RX_RSSI_DBM),
    OSD_ELEMENT_ENTRY("RX UP LQ", OSD_RX_LQ),
    OSD_ELEMENT_ENTRY("RX UP SNR DBM", OSD_RX_SNR_DBM),
    OSD_ELEMENT_ENTRY("TX RF MODE", OSD_RX_MODE),
    OSD_ELEMENT_ENTRY("TX POWER", OSD_RX_TX_POWER),
